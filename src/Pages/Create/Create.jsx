...
const Create = () => {
  ...
  var str = `<svg width="800" height="600" xmlns="http://www.w3.org/2000/svg">
 <g>
  <title>Layer 1</title>
 ...
 <defs>
  ...
  <linearGradient y2="1" x2="0.55469" y1="0" x1="0" id="svg_90">
   <stop offset="0" stop-opacity="0.99609" stop-color="hsl(${gradient1}, 48%, 36%)"/>
   <stop offset="1" stop-opacity="0.99219" stop-color="hsl(${gradient2}, 55%, 18%)"/>
  </linearGradient>
  ...
  const create = async () => {
    ...
    const mintedNFT = await contract.methods.mint("Roman", str).send({
      from: address,
  ...
  const getRandomNums = async () => {
    ...
    str = `<svg width="800" height="600" xmlns="http://www.w3.org/2000/svg">
 <g>
  <title>Layer 1</title>
  <rect fill="url(#svg_90)" x="0.9091" y="-28.1819" width="800" height="800" id="svg_15"/>
  <path stroke-width="2" stroke="#0f0f00" stroke-opacity="0.5" fill="url(#svg_29)" opacity="undefined" d="m394.5,531c-126.24309,0 -228.5,-101.36187 -228.5,-226.5c0,-125.13813 102.25691,-226.5 228.5,-226.5c126.24309,0 228.5,101.36187 228.5,226.5c0,125.13813 -102.25691,226.5 -228.5,226.5z" id="svg_17"/>
